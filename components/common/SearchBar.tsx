...
function SearchBar() {
  return (
    ...
    <div className="md:h-60 h-40 w-full flex items-center justify-center flex-col">
        <div className="w-4/5 md:h-16 h-10 flex justify-center md:rounded-xl rounded-lg drop-shadow-md bg-gray-100">
          <input 
            type="text"
        ...
        <div className="flex w-3/4 justify-end mt-3">
          <button className="flex flex-row hover:text-blue-100 text-blue-800 md:mr-3 mr-0">
            <FilterIcon className="md:w-4 w-3" />
            <p className="md:text-sm text-xs ml-2">Filter Search</p>
          </button>
        </div>
    </div>
    </Fade>
