    ...
    <div className="w-full md:h-[650px] h-[250px] flex flex-row item-center">
      <Fade left>
        <div className="flex flex-col justify-center z-10 md:-mt-0 -mt-10">
          ...
          <button className="font-display-200 md:h-14 h-8 md:w-60 w-32 md:ml-20 ml-10 bg-gradient-to-b from-blue-700 to-blue-100 md:rounded-xl rounded-md text-white md:text-xl text-md font-light md:mt-16 mt-5 hover:bg-white hover:text-blue-700 drop-shadow-3xl">
            Start Now
          </button>
        </div>
      </Fade>
