      ...
      <Fade left>
        <div className="flex flex-col justify-center z-10 md:-mt-0 -mt-10">
          <div className="flex flex-row items-center md:ml-20 ml-10">
            <p className="text-blue-700 font-display-400 font-light md:text-6xl text-2xl">{textReturn(language,'Help')}</p>
            <p className="text-yellow-300 font-display-500 font-regular md:text-7xl text-3xl md:ml-5 ml-3">{textReturn(language,'Students')}</p>
          </div>
          <div className="flex flex-row items-center md:ml-20 ml-10">
            <p className="text-blue-700 font-display-400 font-light md:text-6xl text-2xl md:w-[510px] w-[210px]"> {textReturn(language,'Reach')}</p>
          </div>
          <button 
