  ...
  return (
    <div className="w-full md:h-screen h-[500px] flex flex-col justify-center items-center md:gap-y-20 gap-y-10">
      ...
      <div className="flex flex-row md:gap-x-10 gap-x-5 w-full overflow-x-scroll md:justify-center justify-none p-5">
        ...
        <TeamCard img="ana.png" name={'Ana Iturbe'} job={'Designer'} description={'Systems Engineering Student. Frontend Developer. UI/UX Designer'} linkedin={'https://www.linkedin.com/in/ana-iturbe-416b95217'} git={'https://github.com/anaiturbec'} twitter={''} />
      </div>
    </div>
  );
}
